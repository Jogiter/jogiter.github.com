import{_ as a,z as s,A as n,I as t,B as o,W as p,D as l}from"./plugin-vue_export-helper.71bb0c0b.js";const x='{"title":"lerna with tsdx","description":"","frontmatter":{"title":"lerna with tsdx"},"headers":[{"level":2,"title":"\u4F7F\u7528 lerna \u521B\u5EFA Mono Project","slug":"\u4F7F\u7528-lerna-\u521B\u5EFA-mono-project"},{"level":2,"title":"tsdx","slug":"tsdx"}],"relativePath":"tech/lerna-with-tsdx.md","lastUpdated":1701670426297}',c={},r={id:"frontmatter-title",tabindex:"-1"},i=n("a",{class:"header-anchor",href:"#frontmatter-title","aria-hidden":"true"},"#",-1),d=p(`<p><div class="table-of-contents"><ul><li><a href="#\u4F7F\u7528-lerna-\u521B\u5EFA-mono-project">\u4F7F\u7528 lerna \u521B\u5EFA Mono Project</a></li><li><a href="#tsdx">tsdx</a></li></ul></div></p><h2 id="\u4F7F\u7528-lerna-\u521B\u5EFA-mono-project" tabindex="-1">\u4F7F\u7528 lerna \u521B\u5EFA Mono Project <a class="header-anchor" href="#\u4F7F\u7528-lerna-\u521B\u5EFA-mono-project" aria-hidden="true">#</a></h2><div class="language-"><pre><code># \u521B\u5EFA\u9879\u76EE
lerna init
...
<span class="token punctuation">}</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre></div>`,17);function u(e,m,h,k,g,f){return l(),s("div",null,[n("h1",r,[t(o(e.$frontmatter.title)+" ",1),i]),d])}var _=a(c,[["render",u]]);export{x as __pageData,_ as default};
